...
public class MyTokenizer extends Tokenizer {
  ...
  MyTokenizer(int minGram, int maxGram, boolean edgesOnly) {
   ...
   */
  public MyTokenizer(int minGram, int maxGram) {
    this(minGram, maxGram, false);
  }

  MyTokenizer(AttributeFactory factory, int minGram, int maxGram, boolean edgesOnly) {
    super(factory);
    init(minGram, maxGram, edgesOnly);
  }
   ...
   * @param maxGram the largest n-gram to generate
   */
  public MyTokenizer(AttributeFactory factory, int minGram, int maxGram) {
